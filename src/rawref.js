...
Se.defined = function (s, e = "value") {
  if (s === void 0) throw new Error(`${e} is undefined`);
};
...
const tm = class tm {
  ...
  contains(e, t) {
    ...
    return i === void 0 ? !1 : oy(i, e, t) !== null;
  }
  mute() {
...
const Kc = class Kc {
  ...
  fromJSON(e) {
    const t = e.position;
    t !== void 0 ? this.position.fromJSON(t) : this.position.copy(Z.zero);
    const r = e.rotation;
    r !== void 0 ? this.rotation.fromJSON(r) : this.rotation.copy($e.identity);
    const i = e.scale;
    i !== void 0 ? this.scale.fromJSON(i) : this.scale.copy(Z.one);
  }
  toJSON() {
    return {
...
function Xo(s, e) {
  return e === void 0 || e === null || typeof e != "object"
    ? !1
    : s instanceof e;
}
function Ky(s) {
...
function r3({
  ...
  function c(d, h) {
    const p = h.pointerId,
      v = o.get(p);
    v === void 0 || (a(p), Bo() - v.timestamp > i) || n.send2(d, h);
  }
  function _(d, h) {
    const p = h.pointerId,
      v = o.get(p);
...
function T3(s) {
  const e = F0[s];
  if (e === void 0) throw new Error(`Unsupported type '${s}'`);
  return e;
}
function Re(s, e, t) {
  if (s === null) return 0;
...
function yn(s, e) {
  ...
  for (; r < t; r++) {
    const i = s[r],
      n = e[r];
    if (i !== n) {
      if (i == null || n === void 0 || n === null) return !1;
...
function St(s, e) {
  return s === e
    ? !0
    : s === void 0 || e === void 0 || s === null || e === null
    ? !1
    : s.equals(e);
}
function lr(s) {
  return s === void 0 ? 0 : s.hash();
}
const Me = {
  Position: "position",
  Normal: "normal",
...
(Hu = new WeakMap()),
  ...
  ($0 = function () {
    ...
    if (e === null || t === void 0 || r === void 0 || i === void 0)
      throw new Error(
...
class Ct {
  ...
  getOrSet(e, t) {
    const r = this.get(e);
    return r !== void 0 ? r : (this.set(e, t), t);
  }
  delete(e) {
    const t = P(this, Pe, Gc).call(this, e);
    let r = this.compute_bin_index(t);
...
class pr {
  ...
  get(e) {
    const t = this.data.get(e);
    return t === void 0 ? null : (this.__promote(t), t.value);
  }
  getOrCompute(e, t, r) {
    const i = this.get(e);
    if (i !== null) return i;
  ...
  silentRemove(e) {
    const t = this.data.get(e);
    return t === void 0 ? !1 : (this.__removeElement(t), !0);
  }
  clear() {
    const e = [];
    G3(e, this.data.keys());
...
function n1(s) {
  const e = s1[s];
  if (e === void 0) throw new Error(`Unsupported data type '${s}'`);
  return e;
}
function o1(s, e, t) {
  let r = t,
...
class et {
  constructor(e = [], t = 1, r = 0, i = 0) {
    ...
    if (e === void 0) throw new Error("data was undefined");
    if (e.length < r * i * t)
      throw new Error(
...
function v1(s, e, t, r) {
  if (s === e) return !0;
  if (s === null || e === null || s === void 0 || e === void 0) return !1;
  const i = s.length;
...
const Wu = class Wu extends la {
  ...
  static from(t, r, i) {
    ...
    return (
      (n.geometry = t),
      (n.material = r),
      i !== void 0 && n.transform_local.set(i),
      n.updateMatrices(),
      n
    );
  }
...
class Qr {
  ...
  clear() {
    if (getProperty(this, Or) !== Fc) {
      ...
      do
        (getProperty(this, Ge)[e] = void 0),
          (e = P(this, Oe, Vc).call(this, e));
      while (e !== t);
      S(this, Or, Fc);
    }
  ...
  removeFirst() {
    ...
    return (
      (getProperty(this, Ge)[getProperty(this, at)] = void 0),
...
class O1 {
  ...
  generateMipmap(e, t, r) {
    ...
    let _ = !1;
    r === void 0 && ((r = c.createCommandEncoder({})), (_ = !0));
    for (let u = 0; u < o; ++u) {
      let d = e.createView({
          baseMipLevel: 0,
          mipLevelCount: 1,
...
(bl = new WeakMap()),
  ...
  (ev = function (e) {
    return (
      this.mipmapShaderModule === void 0 &&
    ...
    if (this.loadImageSlots) {
      ...
      for (const c of e.materials)
        for (const _ of this.loadImageSlots) {
          ...
          u !== void 0 && n.add(e.textures[u.index].source);
        }
    }
    const o = [];
    for (let c = 0; c < ((a = e.images) == null ? void 0 : a.length); ++c) {
...
function H1(s, e) {
  ...
  r !== void 0 && (t.texture_normal = e[r.index]);
  ...
  if (n !== void 0) {
    ...
    a !== void 0 && t.diffuse_color.fromArray(a);
    ...
    _ !== void 0 && (t.texture_orm = e[_.index]),
  ...
  if (o !== void 0) {
    ...
    c !== void 0 && (c.specularFactor, c.specularColorFactor);
  }
  return t;
}
function Zm(s) {
  ...
  function t(r) {
    const i = r.accessors,
      ...
      v = (r.textures ?? []).map((N) => {
        ...
        L !== void 0 &&
          (I = (J = L.EXT_texture_webp) == null ? void 0 : J.source),
          I === void 0 && (I = N.source);
        const F = d[I];
        let D;
        r.samplers !== void 0 && r.samplers[M] !== void 0
          ? (D = r.samplers[M])
          : (D = p);
        const H = pc.from(F);
        return (
    ...
    function E(N, M) {
      ...
      if (L.byteStride !== void 0 && L.byteStride !== H * D)
    ...
    function A(N, M) {
      ...
      let L = y.get(I);
      return L === void 0 && ((L = E(N, M)), y.set(I, L)), L;
    }
    function T(N) {
      const M = new uf();
      ...
      return (
        N.indices !== void 0 && (M.index = A(N.indices, "index")),
        M.index !== null &&
          q1 &&
    ...
    function z(N) {
      ...
      let I = u.get(M);
      return I === void 0 && ((I = T(N)), u.set(M, I)), I;
    }
    function C(N, M) {
      const I = c[N],
        L = I.primitives,
      ...
      for (let H = 0; H < F; H++) {
        const J = L[H],
          R = z(J);
        F === 1 && I.name !== void 0 && (R.name = I.name);
        const O = J.material;
        let q;
        O !== void 0 ? ((q = m[O]), q === void 0 && (q = h)) : (q = h);
        const Y = new Iu();
        (Y.geometry = R),
          (Y.material = q),
          Y.transform_global.set(M.worldMatrix),
          I.name !== void 0 && (Y.name = I.name),
          D.push(Y);
      }
      return D;
    }
    function U(N, M) {
      ...
      if ((L === void 0 && (L = new la()), I.matrix !== void 0))
        L.transform_local.set(I.matrix);
      else {
        const F = new Mo();
        I.translation !== void 0 && F.position.fromArray(I.translation),
          I.rotation !== void 0 && F.rotation.fromArray(I.rotation),
          I.scale !== void 0 && F.scale.fromArray(I.scale),
          L.transform_local.set(F.matrix);
      }
      if ((N.addChild(L), I.children !== void 0))
...
const nm = class nm extends wn {
  ...
  fromJSON(t) {
    super.fromJSON(t),
      (this.size = t.size),
      t.mipLevelCount !== void 0
        ? (this.mipLevelCount = t.mipLevelCount)
        : (this.mipLevelCount = 1),
      t.sampleCount !== void 0
        ? (this.sampleCount = t.sampleCount)
        : (this.sampleCount = 1),
      t.dimension !== void 0
        ? (this.dimension = t.dimension)
...
function cp(s) {
  ...
  if (e !== null) {
    const r = e.groups,
      i = r.type;
    let n;
    r.count === void 0 ? (n = -1) : (n = parseInt(r.count));
    const o = cp(i),
      a = new X();
    return (a.type = o), (a.count = n), a;
  }
  const t = Ce[s];
  if (t === void 0) throw new Error(`Unsupported type '${s}'`);
  return t;
}
class _w {
  constructor() {
...
const Qu = class Qu extends Fd {
  ...
  get(t) {
    ...
    if (r === void 0) throw new Error(`Field '${t}' not found`);
    return r;
  }
  get wgsl_ref() {
...
function hw(s, e, t) {
  ...
  for (let o = 0; o < n; o++) {
    ...
    const c = s[a.name];
    c !== void 0 && lp(c, e, a.type);
  }
}
function lp(s, e, t) {
  if (((e.position = Wt(t.align, e.position)), t instanceof X))
    return dw(s, e, t);
  if (t instanceof W) return hw(s, e, t);
  switch (t) {
    case Ce.u32:
    case Ce["atomic<u32>"]:
...
class fw {
  ...
  add(e, t) {
    let r = this.data.get(e);
    if (r === void 0) (r = []), this.data.set(e, r);
...
class pw {
  ...
  get(e) {
    ...
    if (
      (t === void 0 && (t = getProperty(this, Fn).createResource(e)),
      getProperty(this, ci).get(t) !== void 0)
    )
  ...
  release(e) {
    ...
    if (t === void 0) throw new Error("Resource is not managed");
...
const om = class om {
  ...
  destroy() {
    getProperty(this, er) !== void 0 &&
      (getProperty(this, er).destroy(), S(this, er, void 0)),
      getProperty(this, Tl).clear(),
      S(this, Ls, bw);
  }
  clear() {
    if (getProperty(this, er) !== void 0) throw new Error("Not Implemented");
  }
...
(li = new WeakMap()),
  ...
  (Tf = function (e = !0) {
    ...
    getProperty(this, Tr) !== void 0 && getProperty(this, Tr).destroy();
...
fn light_read_record_point(address:u32) -> ${_a.wgsl_ref}{
  ...
  Ui = W.from({ direction: "vec3<f32>", color: "vec3<f32>" }, "IncidentLight"),
  xn = W.from(
    {
...
class So {
  ...
  fromJSON({
    ...
    (this.binding = e),
      (this.visibility = t),
      r !== void 0 ? (this.buffer = Ee.fromJSON(r)) : (this.buffer = void 0),
      i !== void 0 ? (this.sampler = sl.fromJSON(i)) : (this.sampler = void 0),
      n !== void 0 ? (this.texture = kr.fromJSON(n)) : (this.texture = void 0),
      o !== void 0
        ? (this.storageTexture = Uc.fromJSON(o))
        : (this.storageTexture = void 0),
      a !== void 0
        ? (this.externalTexture = Hd.fromJSON(a))
        : (this.externalTexture = void 0);
  }
  hash() {
    return ot(
      this.binding,
...
class og {
  ...
  fromJSON(e = {}) {
    e.compare !== void 0
      ? (this.compare = e.compare)
      : (this.compare = "always"),
      e.depthFailOp !== void 0
        ? (this.depthFailOp = e.depthFailOp)
        : (this.depthFailOp = "keep"),
      e.failOp !== void 0 ? (this.failOp = e.failOp) : (this.failOp = "keep"),
      e.passOp !== void 0 ? (this.passOp = e.passOp) : (this.passOp = "keep");
  }
}
const ag = !1,
  cg = "always",
...
class Ic {
  ...
  fromJSON(e = {}) {
    e.color !== void 0 ? this.color.fromJSON(e.color) : this.color.default(),
      e.alpha !== void 0 ? this.alpha.fromJSON(e.alpha) : this.alpha.default();
  }
  equals(e) {
...
class Nu {
  ...
  fromJSON(e) {
    e.topology !== void 0 ? (this.topology = e.topology) : (this.topology = dg),
...
class Je {
  ...
  draw({ encoder: e, timer: t, bindings: r = {}, colorAttachments: i = [] }) {
    ...
    n.draw(3), n.end(), t !== void 0 && t.update(e);
  }
}
...
class Zw {
  ...
  getEmptySlot() {
    for (let e = 0; e < 1024; e++)
      if (getProperty(this, _i)[e] === void 0) return e;
...
class fe {
  ...
  createGroup({ index: e = P(this, ad, Uv).call(this), label: t = "" } = {}) {
    if (getProperty(this, Er)[e] !== void 0)
    ...
    for (let n = 0; n < r; n++) {
      ...
      for (let u = 0; u < _; u++) {
        ...
        if (d.type === Et.Buffer) {
          ...
          else if (!(typeof h == "object" && h.buffer !== void 0))
...
(Er = new WeakMap()),
  ...
  (Uv = function () {
    for (let e = 0; e < 1024; e++)
      if (getProperty(this, Er)[e] === void 0) return e;
    throw new Error("All slots are used up");
  });
var Nl, Aa, Ml;
const _m = class _m {
  ...
  static from({ label: e, resources: t, body: r }) {
    const i = new _m();
    return S(i, Ml, r), S(i, Aa, t), e !== void 0 && S(i, Nl, e), i;
  }
};
...
class kc {
  ...
  resolve(e) {
    if (getProperty(this, Ar) === void 0) return;
...
`);
W.from({ output_resolution: "vec2<u32>" });
const $v = new fe();
$v.createGroup()
...
(Os = new WeakMap()),
  ...
  (Hv = function (e, t) {
    ...
    const a = P(this, ws, Af).call(this),
      c = o * a;
    getProperty(this, di) !== void 0 && getProperty(this, di).destroy(),
      S(
        this,
        di,
...
const Vi = W.from({ bounds: "array<f32,6>" }, "MeshletBounds"),
  vs = W.from({ index: "u32", mesh: "u32" }, "MeshletDefinition"),
  Xe = W.from(
    {
      geometry: "u32",
      material: "u32",
  ...
  xe = W.from({ min: "vec3<f32>", max: "vec3<f32>" }, "AABB"),
  $_ = w.from(
    `
...
class Mr extends Sv {
  ...
  static simplified({ label: t = "", code: r, bindings: i, constants: n }) {
    ...
    return (
      ...
      n !== void 0 && (o.compute.constants = n),
      o
    );
  }
  static fromJSON(t) {
...
let Yt = um;
const MT = W.from({ count: "atomic<u32>", elements: X.from(vs) }),
  kT = W.from({ count: "u32", elements: X.from(vs) }),
  Wd = new fe();
Wd.createGroup()
...
`,
  ...
  FT = W.from({ count: "atomic<u32>", elements: X.from(xs) }),
  DT = W.from({ count: "u32", elements: X.from(xs) }),
  Jd = new fe();
Jd.createGroup()
  .addUniform("camera", ce)
  .addUniform("view", hn)
...
function ht({
  ...
  if (r === void 0) {
    if (i === void 0) throw new Error("Unexpected state");
  }
  const o = {},
    a = Object.keys(t);
  function c(p, v, f) {
    ...
    for (let y = 0; y < a.length; y++) {
      const A = a[y],
        T = e.descriptor.resources.getResourceByName(A);
      if (T === void 0) throw new Error(`No resource called '${A}'`);
      const z = p[A];
      let C;
  ...
  const _ = s.add(e.descriptor.label, o, c);
  ...
  const d = e.pipeline.fragment.targets[0];
  let h;
  return (
    i !== void 0
      ? (h = _.write(i))
...
class zE {
  constructor(e, t, r) {
    ...
    S(this, Xn, i),
      ...
      S(this, Pa, new t2(i, Object.keys(cr).length)),
      S(this, Ba, new AE(e));
  }
  setJitter(e, t) {
  ...
  get frame_index() {
    return getProperty(this, La);
  }
  get stats() {
    return getProperty(this, Pa);
  }
  get sky() {
    return getProperty(this, Ba);
  }
  setViewportSize(e, t) {
    (getProperty(this, jn)[0] = e),
      (getProperty(this, jn)[1] = t),
  ...
  update_uniforms() {
    ...
    cf(
      ...
      Fo(
        {
          frame_index: getProperty(this, La),
          width: r[0],
          height: r[1],
          projection_matrix: t,
  ...
  finish_frame(e) {
    getProperty(this, dd).set(
      ...
      getProperty(this, Pa).readback(),
      ze(this, La)._++;
  }
  destroy() {
    getProperty(this, uniform_buffer) !== void 0 &&
      (getProperty(this, uniform_buffer).destroy(),
      S(this, uniform_buffer, void 0)),
      getProperty(this, gpu_previous_camera_state) !== void 0 &&
        (getProperty(this, gpu_previous_camera_state).destroy(),
        S(this, gpu_previous_camera_state, void 0)),
...
`,
  IE = W.from({ count: "u32", elements: X.from(xs) }),
  NE = W.from({ camera: ce, width: "u32", height: "u32" }),
  x2 = new fe();
x2.createGroup()
  .addUniform("view", NE)
  .addUniform("camera", ce)
  ...
  const r = s.view,
    ...
    p = a.constructRenderPass({
      ...
      bindings: zf.resources.generateBindings({
        ...
        geometries: n.buffer_metadata,
        geometry_indices: n.buffer_indices,
        geometry_vertices: n.buffer_vertices,
        triangles: d,
      }),
    });
  console.log(p, a), p.drawIndirect(h, 0), p.end();
};
console.log("skbvkjabdlbadksbj");
function xc(s, e) {
  const t = e.length;
  t >= s.length
    ? e.set(s, 0)
...
fn get_multiscatter_values( 
  ...
  BE = W.from({ steps: "u32", sqrt_samples: "u32" }),
  y2 = new fe();
...
function Rp(s, e) {
  ...
  if (e instanceof W) return JE(s, e);
  switch (e) {
    case Ce.u32:
    case Ce["atomic<u32>"]:
      return s.readUint32();
...
async function Uf({ buffer: s, device: e, type: t, offset: r = 0, count: i }) {
  ...
  if (n) {
    ...
    i = 1;
  } else i === void 0 && (i = Math.floor((s.size - r) / t.size));
  let o;
  return (
...
const Co = W.from({ probe_count: "u32" }, "LightProbeVolumeMetadata");
...
(ql = new WeakMap()),
  ...
  (Hs = new WeakMap()),
  ($a = new WeakMap());
const wu = W.from({ instance_count: "u32" });
let IA = 0;
...
(Ys = new WeakMap()),
  ...
  (MA = function () {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      if (n === void 0 || getProperty(this, xi)[n * 2] !== i.id) continue;
      getProperty(this, xi)[n * 2 + 1] !== i.version && S(this, ro, !0);
    }
  });
const L2 = W.from({ count: "atomic<u32>", elements: "array <u32>" }),
  rh = new fe();
rh.createGroup()
...
const j_ = 64,
  P2 = W.from({ triangles: X.from(Ce.u32, j_) }, "MeshletData"),
  jg = W.from({ count: "atomic<u32>", elements: X.from(xs) }),
  BA = W.from({ count: "u32", elements: X.from(xs) }),
  ih = new fe();
ih.createGroup()
  .addUniform("camera_current", ce)
  .addUniform("camera_previous", ce)
...
const GA = (s, e, t) => {
  ...
  VA = W.from({ count: "u32", data: "array<u32>" }),
  $A = W.from({ count: "atomic<u32>", elements: X.from(vs) }),
  B2 = new fe();
B2.createGroup()
...
fn unpack(@builtin(global_invocation_id) global_id : vec3<u32>){
  ...
  O2 = W.from({ meshlet_count: "u32", meshlet_offset: "u32" }),
  YA = W.from({ count: "atomic<u32>", data: X.u32 }),
  jA = W.from({ count: "u32", elements: X.u32 }),
  Lp = new fe();
Lp.createGroup()
  .addStorageBuffer("meshes", X.from(Xe))
...
function Xg({
  ...
  (c.command = u.read(_)),
    ...
    o !== void 0 && Zt(s, o, rt.MeshletBatches, c.output);
...
const QA = W.from({ count: "atomic<u32>", elements: X.from(xs) }),
  eS = W.from({ count: "u32", elements: X.from(vs) }),
  sh = new fe();
sh.createGroup()
  .addStorageBuffer("meshes", X.from(Xe))
  .addStorageBuffer("meshlet_data", X.from(P2));
...
const iS = W.from({ count: "u32", elements: X.from(vs) }),
  Zg = W.from({ count: "atomic<u32>", elements: X.from(vs) }),
  Pp = new fe();
Pp.createGroup()
  .addUniform("camera_current", ce)
  .addUniform("camera_previous", ce)
...
const wd = class wd {
  ...
  destroy() {
    getProperty(this, ss) !== void 0 &&
      (getProperty(this, ss).destroy(), S(this, ss, void 0));
  }
};
...
function NS(s, e, t, r = new Uint32Array(e.length / 3), i, n = 0) {
  ...
  let d = i;
  d === void 0 && ((d = new fr()), D0(d, t, t.length)),
...
class BS {
  ...
  obtain(e) {
    ...
    return t === void 0 && (t = P(this, Ri, K2).call(this, e)), t;
  }
  update(e) {
...
let Bf = hm;
const Kh = W.from({ triangle_offset: "u32", triangle_count: "u32" }),
...
class jS {
  ...
  obtain(e) {
    ...
    return t === void 0 && (t = P(this, It, rx).call(this, e)), t;
  }
  remove(e) {
...
`),
  fn = W.from({ position: "vec3<f32>", normal: "vec3<f32>", primitive: "u32" }),
  lx = w.from(
    `
...
class sz {
  ...
  remove(e) {
    return getProperty(this, Ti).get(e) === void 0
      ? !1
  ...
  write_geometry_vertices(e, t) {
    ...
    i !== void 0 && P(this, Rr, Ff).call(this, n, a, o, r, i.data),
      e.hasAttribute(Me.Normal) || e.computeNormals();
    const c = e.getAttribute(Me.Normal);
    c !== void 0 && P(this, Rr, Ff).call(this, n, a + 3, o, r, c.data),
      e.hasAttribute(Me.Tangent) || e.computeTangents();
    const _ = e.getAttribute(Me.Tangent);
    _ !== void 0 && P(this, Rr, fx).call(this, n, a + 6, o, r, _.data);
    const u = e.getAttribute(Me.UV);
    u !== void 0 && P(this, Rr, hx).call(this, n, a + 10, o, r, u.data);
  }
  destroy() {
  ...
  get(e) {
    ...
    if (t >= 0 && t < this.texture_cache.length) {
      ...
      e.dimension === n.dimension &&
        ...
        (r = i),
        r !== void 0 && this.texture_cache.splice(t, 1);
    }
    return (
      r === void 0 &&
...
class Vz {
  ...
  destroy() {
    getProperty(this, rn) !== void 0 && getProperty(this, rn).destroy();
  }
}
...
const Ro = W.from({ root: "u32", nodes: X.from(Mi) }, "BVH"),
  Hz = w.from(
    `
...
`,
  ...
  Gp = W.from({ bounds: xe, resolution: "vec3<u32>" }),
  Vp = W.from({ count: "atomic<u32>", data: "array<f32>" }),
  $p = new fe();
...
fn sample_material(
  ...
  ef = W.from({ irradiance: "vec3<f32>", distance: "f32", bounces: "i32" }),
  mC = w.from(
    `
...
function PC({
  ...
  function o(c, _, u) {
    const d = _.get(c.output),
      h = _.get(c.depth),
      p = e.scene;
    hu === void 0 && (hu = new kc(u.graphics.device, "LPV lookup bake")), Bo();
...
`),
  m4 = W.from({ jitter: "vec2<f32>", jitter_delta: "vec2<f32>" }),
  lb = new fe();
lb.createGroup()
...
fn is_mirror_reflection(roughness:f32) -> bool{
    ...
    `),
  Z4 = W.from({ max_distance: "f32", frame_index: "u32", edge_fade: "f32" }),
  bb = new fe();
bb.createGroup()
...
class JU {
  ...
  get feature_shadows_enabled() {
    return getProperty(this, dc);
  }
  get feature_lpv_enabled() {
    return getProperty(this, wo);
  }
  set feature_lpv_enabled(e) {
    S(this, wo, e);
  }
  get views() {
    return getProperty(this, an);
  }
  get graphics() {
    return getProperty(this, wt);
  }
  get rasterizer() {
    return getProperty(this, hc);
  }
  get resolution() {
    return getProperty(this, lt).clone();
  }
  get aspect_ratio() {
    return getProperty(this, lt).x / getProperty(this, lt).y;
  }
  ...
  getProbeRendererForScene(e) {
    ...
    return (
      r === void 0 &&
        ((r = new qf(getProperty(this, wt), t)),
  ...
  get_view_stats(e, t, r = !0) {
    const i = new Lu(e, t);
    if (!r && !getProperty(this, an).exists(i)) return {};
    const n = getProperty(this, an).obtain(i);
    return {
  ...
  async initialize({
    ...
    presentationFormat: i = navigator.gpu.getPreferredCanvasFormat(),
  }) {
    if (e === void 0) {
      const a = document.createElement("canvas");
      (a.width = window.innerWidth),
        (a.height = window.innerHeight),
        (e = a.getContext("webgpu"));
    }
    if (t === void 0) {
      const c = await navigator.gpu.requestAdapter({
        powerPreference: "high-performance",
      });
      if (c === null) throw new Error("Failed to bind GPUAdapter");
      c.isFallbackAdapter;
      const _ = c.limits.maxStorageBuffersPerShaderStage;
      if (_ < 10)
        throw new Error(
          `Engine requires at least 10 storage buffers per shader stage, actual is ${_}`
        );
      t = await c.requestDevice({
        requiredLimits: {
    ...
    (this.context = e),
      (this.device = t),
      (this.presentation_format = i),
      S(this, ln, r),
      getProperty(this, cn).set(e.canvas.clientWidth, e.canvas.clientHeight),
      P(this, nt, Jf).call(this),
      S(this, wt, new Vz(t));
    const n = getProperty(this, wt);
    (this.gBuffer = new AT(n)),
      S(this, uc, new kU(n)),
      S(this, L_, new Cw(this.device)),
      S(this, an, new jU(n, getProperty(this, L_), getProperty(this, uc))),
      S(this, hc, new dS(n));
    const o = getProperty(this, lt).asArray();
    ...
    this.gBuffer.init(getProperty(this, lt).asArray()),
      S(this, jr, new sU(getProperty(this, wt))),
      S(this, B_, new YU(getProperty(this, wt))),
  ...
  init_render_targets() {
    const e = new Ov();
    S(this, Xr, e);
    const t = getProperty(this, wt).textures;
    (e.color_attachments = [
      t.contextFromDescriptor(
        mt.from({
          size: getProperty(this, lt).asArray(),
          format: "r32uint",
          usage:
            GPUTextureUsage.RENDER_ATTACHMENT | GPUTextureUsage.TEXTURE_BINDING,
        })
  ...
  render(e, t) {
    P(this, nt, Lb).call(this),
      getProperty(this, wt).update(),
      getProperty(this, wo) && this.update_lpv(t);
    const r = Lu.from(e, t),
      i = getProperty(this, an).obtain(r),
      n = getProperty(this, jr).taa;
    i.setJitter(n.Jitter[0], n.Jitter[1]),
      i.setViewportSize(getProperty(this, lt).x, getProperty(this, lt).y),
      i.camera.setViewportOffset(
        n.Jitter[0] / getProperty(this, lt).x,
        n.Jitter[1] / getProperty(this, lt).y
      );
    const o = Ni.create(getProperty(this, wt), "Renderer/main"),
      a = getProperty(this, Xr);
    getProperty(this, hc).execute(i, o, a),
      getProperty(this, wt).materials.viz_render(
        o,
        i,
        a,
...
(ds = new WeakMap()),
  ...
  (Wf = function () {
    const e = getProperty(this, lt).x,
      t = getProperty(this, lt).y;
  ...
  (Jf = function () {
    ...
    getProperty(this, ln),
      getProperty(this, lt).set(e.x, e.y),
      getProperty(this, lt).ceil();
  }),
  (Lb = function () {
  ...
  (Bb = function (e, t) {
    const r = getProperty(this, lt).asArray(),
      i = t.scene,
      n = i.lights,
      o = new O_("Shading"),
...
function ZU(s, e) {
  const t = Y1("pica_pica/pica_pica.gltf").then((i) => s.addNodes3D(i));
  s.lights.add(g1({ intensity: 2.2 }));
  const r = {
    position: {
      x: 7.990444788625961,
  ...
  return e.transform.fromJSON(r), t;
}
const KU = async ({ canvas: s, gui: e }) => {
  const t = s.getContext("webgpu"),
    r = new JU();
  await r.initialize({ context: t });
  const i = new x3();
  i.transform.position.set(0, 0, -5),
    i.transform.lookAt(Z.zero),
    (i.near = 0.1),
    (i.far = 2e4),
    (i.fov = 72 * p0),
    (i.aspect = r.aspect_ratio);
  let n = 1 / 0;
  const o = new M2();
  (window.scene = o), new zu(3, 2);
  async function a() {
    r.indicate_view_change(), await m0(1e3);
  }
  ZU(o, i).then(a);
  const c = new p3(i, document.body);
  c.distanceLimits.max = 1e4;
  function _() {
    o.instances.instances.filter((v) => d0(...v.bounding_box, i.frustum) > 0);
  }
  (window.renderer = r), (window.visible = _);
  const u = r.get_view_stats(i, o),
    d = [
      e.add(u, "instances_visible"),
      e.add(u, "meshlets_visible"),
      e.add(u, "triangles_visible"),
    ];
  function h() {
    return o.lights.elements[0];
  }
  e.add(r, "feature_shadows_enabled").name("shadows"),
    e.add(r, "feature_ssr_enabled").name("SSR"),
    e.add(r, "feature_ssao_enabled").name("SSAO"),
    e.add(r, "feature_bloom_enabled").name("Bloom"),
    e.add(r, "feature_taa_enabled").name("TAA"),
    e.add(r, "feature_lpv_enabled").name("LPV"),
    e
      .add(
        {
          get sun_x() {
          ...
          set sun_x(v) {
            const f = h().direction;
            f.setX(v), f.normalize(), (o.lights.needsUpdate = !0);
          },
        },
        "sun_x"
      )
      ...
      .add(
        {
          ...
          set sun_y(v) {
            const f = h().direction;
            f.setZ(v), f.normalize(), (o.lights.needsUpdate = !0);
          },
        },
        "sun_y"
      )
